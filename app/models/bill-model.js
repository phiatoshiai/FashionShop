...
var billSchema = new Schema({
  ...
  pay: {
    ...
    note: { type: String }, //ngân hàng, momo, đưa trực tiếp cho A B C ...  
  },
  status: {
    type: String,
    enum: [
      '60fda515-7aca-498e-80fe-e93d1dd6dd94', // Pending
      '20105183-5743-4e68-95ea-67743d032125', // Confirmed-CallPhone-messager
      '97dd8156-054b-4713-a68c-bba5f5dac309', // Success - received
